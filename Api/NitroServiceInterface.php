...
interface NitroServiceInterface {
    ...
    public function isCheckCartRoute($route); // checks that can only be done after the request has been routed,$route is the ->getFullActionName() of the Magento\Framework\App\Request\Http that is about to be executed, typically module_controller_action
